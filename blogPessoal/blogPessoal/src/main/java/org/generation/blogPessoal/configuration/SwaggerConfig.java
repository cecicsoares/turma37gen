...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
			...
			.licenseUrl("https://github.com/cecicsoares")
			.contact((springfox.documentation.service.Contact) contact())
			.build();
			}
			private static Contact contact() {
			return new Contact("Cecília Soares", 
			"https://github.com/cecicsoares", 
			"cecilia.soares13@gmail.com");
			}
