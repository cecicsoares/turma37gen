	...
	public static void main(String[] args) {
		...
		*/
		...
		if (respostaInicial == 'S') {
			...
			System.out.println("Valor total do carrinho: " +c1.getEstoqueCarrinho());
			//FORMA DE PAGAMENTO
			System.out.print("\n____\n");
			...
			if(formaPagamento == 1){
				valorComDesconto = c1.getEstoqueCarrinho() - (c1.getEstoqueCarrinho() * 10)/100;
				...
				if(respostaParcelas == 's' || respostaParcelas == 'S'){
					...
					valorComImpostoParcela = c1.getEstoqueCarrinho() + (c1.getEstoqueCarrinho() * 15)/100;
					...
					System.out.print("\n____\n");
					System.out.print("\nVALOR TOTAL DA SUA COMPRA: "+(c1.getEstoqueCarrinho()));
					System.out.print("\n____\n");
					...
					System.out.print("\nVALOR TOTAL DA COMPRA: R$"+(c1.getEstoqueCarrinho()));
					System.out.print("\n\nDESEJA GERAR O BOLETO PARA O PAGAMENTO? ");
					(respostaBoleto) = leia.next().charAt(0);
					if(respostaBoleto =='n' || respostaBoleto == 'N'){
						System.out.print("\n >>> OBRIGADE PELA PREFERÊNCIA <<<\n");
